...
//wanted to define the onclick functions that users will use to start and stop the game
...
function userAnswers() {
 var q1 = document.forms["triviaGame"]["q1"].value;
 var q2 = document.forms["triviaGame"]["q2"].value;
 var q3 = document.forms["triviaGame"]["q3"].value;
 var q4 = document.forms["triviaGame"]["q4"].value;
 var q5 = document.forms["triviaGame"]["q5"].value;
